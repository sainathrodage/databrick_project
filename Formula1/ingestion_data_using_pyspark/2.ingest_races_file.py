...
races_with_timestamp_df_final = add_ingestion_date(races_with_timestamp_df)
...
races_selected_df = races_with_timestamp_df_final.select(col('raceId').alias('race_id'), col('year').alias('race_year'), 
